  ...
  return new Vuex.Store({
    state: {
      ...
      blogs: [
        {
          ...
          alt: "coffee cup",
          intro:
            "In this blogpost, I’ll be going through the steps to set up a basic RESTful API with full CRUD act...",
          url:
            "https://medium.com/datadriveninvestor/creating-a-restful-api-with-node-js-and-express-17af18ea92e8",
        ...
        },
        {
          ...
          alt: "React.js logo",
          intro:
            "In this blogpost I’ll be going through the steps to create a controlled form. To start out...",
          url: "https://medium.com/swlh/controlled-forms-in-react-4d223aa33e03",
          date: "October 8th, 2019"
        },
        {
          title: "Making a (sometimes) Fixed Navbar",
          image: "compass.jpeg",
          alt: "navbar image",
          intro:
            "In this blog I’ll be building a (sometimes) fixed navbar using React. In our class component...",
          url:
        ...
        },
        {
          ...
          alt: "Ruby Logo",
          intro:
            "I started learning Ruby around three weeks ago, and the change in the efficiency of my progr...",
          url:
            "https://medium.com/ethan-web-dev/ruby-basics-iterating-through-collections-fbe8b6475105",
      ...
      technologies: {
        ...
        "Ruby on Rails":
          "https://github.com/codyshaben/fantasy_football_draft_app",
      ...
      projects: [
        ...
        },
        {
          ...
          description:
            "A Web App to Create Teams and Draft Players for Fantasy Football",
        ...
        },
        {
          title: "Playlister",
          description:
            "A CLI App Based Around the Spotify API for Searching For and Saving Songs to Playlists",
